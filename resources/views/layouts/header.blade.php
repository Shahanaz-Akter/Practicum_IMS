      ...
      <div class="mobile-toggle-icon fs-3">
        ...
        <div class="top-navbar-right ms-auto">
          ...
          <li class="nav-item dropdown dropdown-large">
            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="index2.html#" data-bs-toggle="dropdown">
              <div class="messages">
                 ...
                 <a class="dropdown-item" href="">
                   <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3">
                        ...
                        <small class="mb-0 dropdown-user-designation text-secondary">User Type</small>
                      </div>
                   </div>
                 </a>
               </li>
