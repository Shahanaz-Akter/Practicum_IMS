                        ...
                        <tbody>
                            ...
                            <tr class="col-12">
                                ...
                                <td >
                                    ...
                                    <span class="btn btn-warning">{{  ucfirst(trans($order->status))  }}</span>
                                    @elseif($order->status=='accepted')
                                    <span class="btn btn-success">{{ ucfirst(trans($order->status)) }}</span>
                                    @elseif($order->status=='rejected')
                                    <span class="btn btn-danger">{{ ucfirst(trans($order->status)) }}</span>
                                    @endif
                                </td>
