...
<main class="page-content">
    <div>
        <div class="col-lg-12 ">
            <h6 class="mb-0 text-center text-uppercase">{{$user->user_type}} Profile</h6>
            <div class="card">

                <div class="card-body">
                    <div class="border p-3 rounded">
                        <form class="row g-3" method="post" action="/edituserpost" enctype="multipart/form-data">
                            @csrf
                            
                            <div class="col-12">
                            
                                <div style="text-align: center;">
                                    <img src="{{asset($user->image)}}" alt="" style="border-radius: 50%; border:5px solid black;" id="output">
                                </div>
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <select class="single-select" name="position" value="null" required>
